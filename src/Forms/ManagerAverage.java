 ...
 * @author Raphael
 */
public class ManagerAverage extends javax.swing.JFrame {

   
    /** Creates new form ManagerAverage */
    public ManagerAverage() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerAverage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerAverage().setVisible(true);
            }
        });
    }
