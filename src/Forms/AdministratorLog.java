 ...
 * @author Raphael
 */
public class AdministratorLog extends javax.swing.JFrame {

    /** Creates new form AdministratorLog */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministratorLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministratorLog().setVisible(true);
            }
        });
    }
