...
public class EvaluatorJobChange extends javax.swing.JFrame {
    
     Evaluator evaluator = new Evaluator();
    /** Creates new form EvaluatorJobChange */
    public EvaluatorJobChange() {
          initComponents();
        String user;
        ...
        //populate the jtable
        evaluator.fillJobInformation2(jTable1,user);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "START_DATE", "SALARY", "POSITION", "EDRA", "ANNOUNCE_DATE", "SUBMISSION_DATE"
            }
        ) {
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jButton2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE))
                .add(18, 18, 18)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel7)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       //clear the jtable first
        jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "START_DATE","SALARY","POSITION","EDRA","ANNOUNCE_DATE","SUBMISSION_DATE"}));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(start_date.trim().equals("") || salary.trim().equals("") || position.trim().equals("") || edra.trim().equals("") || submission_date.trim().equals("")) {
                JOptionPane.showMessageDialog(null, "Missing information");
                }
        else {
            try {
                if(evaluator.editWatchJob(start_date,salary,position,edra,submission_date,user,id)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EvaluatorJobChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EvaluatorJobChange().setVisible(true);
            }
        });
    }
