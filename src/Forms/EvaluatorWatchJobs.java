...
public class EvaluatorWatchJobs extends javax.swing.JFrame {
    ...
    public EvaluatorWatchJobs() {
        ...
        String afm = evaluator.getAFM(user);
        //populate the jtable
        evaluator.fillJobInformation3(jTable1,afm);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField6.setText(model.getValueAt(rIndex, 6).toString());
        jTextField5.setText(model.getValueAt(rIndex, 7).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
        int rIndex = jTable1.getSelectedRow();
        String start_date = jTextField1.getText();
        String salary = jTextField2.getText();
        String position = jTextField3.getText();
        String edra = jTextField4.getText();
        String submission_date = jTextField5.getText();
        String announce_date = jTextField6.getText();
        String user = LoginSession.user_username;
        String id = model.getValueAt(rIndex, 0).toString();
        if(start_date.trim().equals("") || salary.trim().equals("") || position.trim().equals("") || edra.trim().equals("") || submission_date.trim().equals("") || announce_date.trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Missing information");
        }
        else {
            try {
                if(evaluator.editWatchJob2(start_date,salary,position,edra,announce_date,submission_date,user,id)) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     //clear the jtable first
        jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "START_DATE","SALARY","POSITION","EDRA","EVALUATOR","ANNOUNCE_DATE","SUBMISSION_DATE"}));
