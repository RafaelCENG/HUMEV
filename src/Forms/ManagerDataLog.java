 ...
 * @author Raphael
 */
public class ManagerDataLog extends javax.swing.JFrame {


    /** Creates new form ManagerDataLog */
    public ManagerDataLog() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Time", "Action", "Table", "Success_OR_Failed"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerDataLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
